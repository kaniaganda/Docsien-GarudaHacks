...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="/home" class="brand-link">
      <img src="img/3d.png" alt="Docsien Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Docsien</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block">Dr. Gaby Wijaya</a>
        </div>
      </div>
